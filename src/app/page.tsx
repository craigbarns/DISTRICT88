...
export default function Home() {
  const categories = [
    { name: "Fashion & Lifestyle", desc: "Everyday essentials to premium fashion collections.", img: "/images/fashion.jpg" },
    { name: "Sportswear", desc: "Performance garments engineered for movement.", img: "/images/sportswear.jpg" },
    { name: "Cycling", desc: "Technical cycling apparel designed around performance, fit, and functionality.", img: "/images/cycling.jpg" },
    { name: "Technical Apparel", desc: "Advanced fabrics and constructions for demanding applications.", img: "/images/technical.jpg" },
    { name: "Swimwear", desc: "Custom swimwear combining fit, materials, and technical construction.", img: "/images/swimwear.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-foreground">
        <div className="absolute inset-0 z-0">
          ...
          <img 
            src="/images/hero.jpg" 
            alt="Garment Manufacturing Material"
